...
void _handleScroll() {
  ...
  if (currentScroll >= maxScroll && 
    ...
    if (!fandProvider.getHadMoreForword || fandProvider.isLoading) return;
    ...
    return Expanded(
      ...
      child: Consumer<FandProvider>(
        ...
        children: [
          ...
          if(_scrollController.hasClients && fandProvider.isLoading &&  _scrollController.position.userScrollDirection == ScrollDirection.forward) showCircularProgressIndicator(),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context , index){
                if(index==fandProvider.getFandModelList.length){
                  if(!fandProvider.getHadMoreForword){
                    return Center(child: Text("No More Data"));
                  }
                  return (fandProvider.isLoading &&  _scrollController.position.userScrollDirection == ScrollDirection.reverse)? showCircularProgressIndicator() : SizedBox.shrink();
                }
