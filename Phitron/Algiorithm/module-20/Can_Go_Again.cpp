// https://www.hackerrank.com/contests/assignment-04-a-introduction-to-algorithms-a-batch-03/challenges/can-go-again/problem
// unsolved
#include<bits/stdc++.h>
using namespace std;
...
int main(){
    ...
    if(flag){
        while ((q--))
        {
            int d;
            cin>>d;
            if(grap[s][d] == LONG_MAX) cout<<"Not Possible"<<endl;
