...
class OnePhotosWithPrompt extends StatefulWidget {
  const OnePhotosWithPrompt({super.key});

  @override
  State<OnePhotosWithPrompt> createState() => _OnePhotosWithPromptState();
}

class _OnePhotosWithPromptState extends State<OnePhotosWithPrompt> {
  @override
