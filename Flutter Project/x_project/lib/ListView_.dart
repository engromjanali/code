...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   // scrollDirection: Axis.horizontal, //default vertical
      //   itemBuilder: (context, index) {
      //     return Text(arrNames[index], style : TextStyle(fontSize: 25, fontWeight: FontWeight.w800));// we can pass here any type of widget(row, column,text,photo ETC)
      //   },
      //   itemCount : arrNames.length,
      //   separatorBuilder: (context, index) {
      //     return Divider(height: 10,thickness: 5,color: Colors.red,indent: 10.0,endIndent: 50.80,);// we can pass here any type of widget
      //   },
      // ),
    );
  }
