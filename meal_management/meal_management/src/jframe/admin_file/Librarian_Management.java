...
public class Librarian_Management extends javax.swing.JFrame {
    ...
    public Librarian_Management(int id) {
        this.id = id;
        initComponents();
        set_profile();     
    }
    ...
    rs1.close();
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, "The LIBRARIAN Already Exist");
    }finally{
            try{
                con.close();
            }catch(Exception e){
    ...
    private void initComponents() {
        ...
        MANAGE_LIBRARIAN.setBackground(new java.awt.Color(0, 0, 255));
        ...
        APPROVE3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        upde.setText("update");
        upde.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel28.setText("Moderator Status");
...
public static void main(String [] args){
    Librarian_Management x = new Librarian_Management(345);
    x.setVisible(true);
}}
